  ...
  if (req.isAuthenticated() && req.user.accessToken) {
    axios
      ...
      .then((response) => {
        ...
        axios
          .get('http://localhost:5000/coursesubmissions', { params: { courses: courses } })
          .then((submissionResponse) => {
            ...
            // Create a JSON string from the courses array
            ...
            console.error("Error fetching /coursesubmissions:", submissionError);
